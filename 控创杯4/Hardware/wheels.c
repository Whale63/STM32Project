...
void left(void)//for front wheels,A goes ahead,B goes against,for back wheels,A goes ahead,B goes back
{
...
void right(void)//for front wheels,A goes back,B goes ahead ,for back wheels,A goes back,B goes ahead
{
